...
import 'package:tung_mqtt_monitor_app/monitor/monitor_data.dart';
...
import './buildBrokerPage.dart';

//class dùng để đọc json
class User {
  String light;
  String temperature;
  String humidity;
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    void navigationTapped(int page) {
      //page được tự động pass vào hàm này bởi flutter khi tab được chọn
    ...
    void onPageChanged(int page) {
      print('i found you');
      //page được tự động pass vào hàm này khi chuyển tab, vào index _page
      //được thay đổi trong hàm setState, từ đó báo cho widget biết cần change UI
      setState(() {
        this._page = page;
      });
    }
          ...
          child: SfRadialGauge(
            ...
            axes: <RadialAxis>[
              RadialAxis(minimum: 0, maximum: 50, pointers: <GaugePointer>[
                NeedlePointer(value: 2, enableAnimation: true)
              ], ranges: <GaugeRange>[
                ...
                GaugeAnnotation(
                    widget: Text('Celsius'), positionFactor: 0.8, angle: 90),
              ]),
            ],
          ),
        ),
          ...
          child: SfRadialGauge(
            ...
            axes: <RadialAxis>[
              RadialAxis(minimum: 0, maximum: 500, pointers: <GaugePointer>[
                NeedlePointer(
                    value: double.tryParse(light), enableAnimation: true)
              ], ranges: <GaugeRange>[
                GaugeRange(startValue: 0, endValue: 200, color: Colors.green),
                GaugeRange(
                    startValue: 200, endValue: 400, color: Colors.orange),
  ...
  void _onMessage(List<MqttReceivedMessage> event) {
    ...
    setState(() {
      ...
      //a.store = (double.tryParse(light));
      //print('Class nay luu tru ${a.getData}');
